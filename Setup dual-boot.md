...
*   `cd $HOME && rm -rf $HOME/SteamDeckrEFInd/ && git clone https://github.com/jlobue10/SteamDeckrEFInd && cd SteamDeck_rEFInd && chmod +x install-GUI.sh && ./install-GUI.sh`
*   Start S**teamDeck\_rEFInd** from desktop
*   Select **Install rEFInd ➤ Create Config ➤ Install Config**
*   Reboot SteamDeck